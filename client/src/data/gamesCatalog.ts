  ...
  guessing: {
    ...
    details: {
      howToPlay: [
        ...
        'اكتب !تخمين متبوعاً بتخمينك في الدردشة',
        'أول إجابة صحيحة تفوز وتنتهي اللعبة فوراً'
      ],
      objective: 'اكتشاف الإجابة السرية من التلميحات قبل غيرك',
      winCondition: 'أول لاعب يرسل الإجابة الصحيحة عبر !تخمين يفوز',
      commands: ['!انضم', '!تخمين <إجابتك>'],
      chatInteraction: 'التخمين عبر كتابة !تخمين متبوعاً بالإجابة في الدردشة'
    }
  },
  drawing: {
    icon: '🎨',
    ...
    details: {
      howToPlay: [
        ...
        'لوّن بكسلات عبر !رسم B5 #ff00aa (إحداثي + كود اللون)',
        'جميع اللاعبون يرسمون على نفس الشبكة المشتركة',
        'خمّن الكلمة عبر !تخمين في أي وقت',
        'عند تخمين الكلمة بشكل صحيح، تظهر الكلمة ويفوز المخمن'
      ],
      objective: 'ارسم لتوضيح الكلمة، أو خمّن الكلمة من الرسم',
      winCondition: 'أول لاعب يخمن الكلمة السرية عبر !تخمين يفوز',
      commands: ['!انضم', '!رسم <إحداثي> <لون>', '!تخمين <كلمة>'],
      chatInteraction: 'الرسم عبر !رسم مع إحداثي ولون هكس، التخمين عبر !تخمين'
    }
  },
  hide_and_seek: {
    icon: '👻',
    ...
    details: {
      howToPlay: [
        ...
        'اختر منطقة واختبئ عبر !اختبئ A1 (المناطق: A1-D4، شبكة 4×4)',
      ...
      commands: ['!انضم', '!اختبئ <منطقة>'],
      chatInteraction: 'الاختباء عبر !اختبئ متبوعاً برمز المنطقة (مثال: !اختبئ B3)'
    }
  },
};
